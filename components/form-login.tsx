  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg border border-gray-200">
        <h2 className="text-2xl font-semibold text-center text-gray-900 mb-8">Iniciar Sesión</h2>
        <Form {...form}>
        ...
        <footer className="mt-8 space-y-6">
          ...
          <div className="space-y-3">
            <Button
              variant="outline"
              className="w-full h-11 text-sm font-medium border-gray-300 hover:bg-gray-50 transition-colors duration-200"
